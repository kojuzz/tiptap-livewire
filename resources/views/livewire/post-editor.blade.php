<div class="w-1/2 mx-auto mt-10 p-10">

    <h1 class="text-center text-2xl font-bold">
        Laravel 12, Livewire 3 and TailwindCSS 4 with Flowbite TipTap Editor
    </h1>
    <div class="w-full min-h-44 my-10 p-5 bg-gray-50 shadow rounded-lg">

        @if ($content)
            <button wire:click="clear" type="button" class="mb-5 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-blue-700 transition">
                Clear
            </button>
        @endif
        <div class="prose">
