<div class="w-full mx-auto mt-10 p-10">

    <h1 class="text-center text-2xl font-bold mb-10">
        Laravel 12, Livewire 3 and TailwindCSS 4 with Flowbite TipTap Editor
    </h1>
    @if ($content)
        <div class="w-full md:w-1/2 mx-auto min-h-32 my-10 p-5 bg-gray-50 shadow rounded-lg items-center">
            <div class="prose prose-lg mx-auto p-4 rounded-lg shadow bg-white dark:bg-gray-800">
                {!! $content !!}
            </div>
            <div class="flex justify-center">
                <button class="my-5 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition" wire:click="clear" type="button">
                    Clear
                </button>
            </div>
        </div>
    @else
        <div class="w-full md:w-1/2 mx-auto border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <form wire:submit.prevent="save" class="space-y-4 p-4">
                ...
                <textarea wire:model="content" id="editorContent" class="hidden"></textarea>
                <div class="px-4 py-2 bg-white rounded-lg shadow dark:bg-gray-800">
                    <label for="wysiwyg-example" class="sr-only">Publish post</label>
                    <div id="wysiwyg-example"
                        class="block w-full min-h-44 px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400">
                    </div>
                </div>
